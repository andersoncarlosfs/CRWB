...
public abstract class AbstractPersistenceTest<S extends AbstractEntity<T>, T extends Comparable<T>> {
    ...
    public static void setUpClass() throws Exception {
        ...
        properties.put(JDBC_URL, "jdbc:postgresql://localhost:5432/CRWB-Zenji");
        ...
        persistenceUnits.put("CRWB-ZenjiPU", properties);
        ...
        emf = Persistence.createEntityManagerFactory("CRWB-ZenjiPU", properties);
    }
